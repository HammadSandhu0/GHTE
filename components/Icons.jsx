// Icon component that accepts 'className' and 'fill' as props
export const ArrowCircleIcon = ({ className = "", fill = "#ffb703" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 1280 1186"
    className={`w-6 h-6 md:w-7 md:h-7 ${className}`} // Default size with optional className for custom styling
    fill={fill} // Default color or custom color passed as a prop
  >
...
export const ArrownRightIcon = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="lucide lucide-circle-check-big h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0"
  >
...
export const PowerZapIcon = () => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M13 2L3 14h9l-1 8 10-12h-9l3-8z" />
  </svg>
);
...
export const MessageSquareQuote = ({ className = "h-6 w-6", ...props }) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
