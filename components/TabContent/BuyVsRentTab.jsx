        ...
        <div>
          ...
          <div className="bg-white rounded-lg border shadow-sm p-6">
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="space-y-1">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>Battery: {purchase.warranty.batteryWarranty}</span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h3 className="font-medium text-lg mb-2">Financing Options</h3>
                <p className="text-gray-700 mb-2">
                  {purchase.financingOptions.available
                    ? "Financing available"
                ...
                {purchase.financingOptions.available && (
                  <ul className="space-y-1">
                    <li className="flex items-start">
                      ...
                      <span>
                        Minimum Purchase:{" "}
                        {purchase.financingOptions.minimumPurchase}
                      </span>
                    </li>
                    <li className="flex items-start">
                      <svg
                      ...
                      <span>
                        Typical Terms: {purchase.financingOptions.typicalTerms}
                      </span>
                    </li>
                    <li className="flex items-start">
                      <svg
                      ...
                      <span>
                        Down Payment: {purchase.financingOptions.downPayment}
                      </span>
                    </li>
                  </ul>
                )}
