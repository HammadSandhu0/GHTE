...
// Import data from serverAndComputerSolutionData.js
import {
  metadata,
  pageHeader,
  Sidebarcategories,
  ...
  benefitItems,
  whychooseus,
} from "@/data/serverAndComputerSolutionData";
  ...
  return (
    <>
      <SEOHead
        ...
        pageUrl="/server-and-computer-solution-in-saudia-arabia" // Use the resolved locale
      />
